...
define('HTTP_SOURCE_PATH', $config['base_url'].'uploads/');
...
define('HTTP_JS_CKEDITOR_ADMIN', $config['base_url'].'assets/ckeditor/');
define('HTTP_JS_CKFINDER_ADMIN', $config['base_url'].'assets/ckfinder/');

define('HTTP_LTE_PATH', $config['base_url'].'assets/lte_admin/');
define('PERMISSION_MENU',array('admin','sub_admin'));
define('PERMISSION_BUTTON',array('admin'));
